...
namespace kforge::api { class ImportManager; }
namespace kforge::util { class ConfigStore; }

namespace kforge::api {

void register_library_routes(httplib::Server&, sqlite3* db, class ImportOrchestrator* import_orch = nullptr);
void register_symbol_routes(httplib::Server&, sqlite3* db);
void register_plugin_routes(httplib::Server&, plugin::PluginManager*);
void register_settings_routes(httplib::Server&, sqlite3* db, class ImportManager* import_manager = nullptr,
                              util::ConfigStore* config = nullptr);
void register_type_routes(httplib::Server&, sqlite3* db);
void register_status_routes(httplib::Server&, sqlite3* db);
void register_classify_routes(httplib::Server&, sqlite3* db, class ImportManager* import_manager = nullptr);
